                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        const Icon(Icons.inventory_2_outlined, size: 48, color: AppTheme.textLight),
                        const SizedBox(height: 16),
                        const Text('No hay productos en el catálogo', style: TextStyle(color: AppTheme.textLight)),
                      ],
                    ),
                  );
                }
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: isChicharronItem ? Colors.orange.withOpacity(0.12) : AppTheme.cardHighlight,
                borderRadius: BorderRadius.circular(12),
              ),
              child: Icon(
                isChicharronItem ? Icons.local_fire_department : Icons.inventory_2,
                color: isChicharronItem ? Colors.orange.shade800 : AppTheme.accent,
                size: 24,
              ),
            ),
